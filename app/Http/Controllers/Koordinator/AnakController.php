...
class AnakController extends Controller
{
    ...
    private $routePrefix = 'anak_koordinator';
    ...
    public function create()
    {
        ...
        return view('koordinator.' . $this->viewCreate, $data);
    }
    ...
    public function edit($id)
    {
        ...
        return view('koordinator.' . $this->viewEdit, $data);
    }
